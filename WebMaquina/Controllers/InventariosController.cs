...
namespace WebMaquina.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            model.listaCliente =_context.CadCliente.ToList(); 
            model.listaMaquiana =_context.CadMaquina.ToList();
            return View(model);
        }
        ...
        public async Task<IActionResult> Create([Bind("IDInventario,IDCliente,IDMaquina,Nome,Modelo,Produto,Valor,Data_")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDInventario,IDCliente,IDMaquina,Nome,Modelo,Produto,Valor,Data_")] Inventario inventario)
        {
